        ...
        list.addListSelectionListener(e -> {
            ...
            try {
                for(Object obj : ExtraLoader.extras.get(h.get(ind)).keySet())
                    if(lang.get(obj.toString()) != null)
                        extraStatus.setText(extraStatus.getText() + "\n" + lang.get(obj.toString()) + ": " + ExtraLoader.extras.get(h.get(ind)).get(obj.toString()));
                    else
                        extraStatus.setText(extraStatus.getText() + "\n" + obj + ": " + ExtraLoader.extras.get(h.get(ind)).get(obj.toString()));
