...
import static com.github.zhuaidadaya.MCH.lib.Resources.initLanguage.initLang;
...
public class languageSet extends Thread {
    ...
    public static HashSet<String> langFile = new HashSet<>();
