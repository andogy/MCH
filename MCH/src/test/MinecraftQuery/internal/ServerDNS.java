...
public class ServerDNS {
    ...
    public ServerDNS(String hostName) throws QueryException {
        resolve(hostName, 0);
    }

    private void resolve(String hostName, int port) throws QueryException {
    ...
    private Record lookupRecord(String hostName, int type) throws QueryException {
    ...
    private int validatePort(int port) throws IllegalArgumentException {
    ...
    public void setQueryPort(int queryPort) throws IllegalArgumentException {
