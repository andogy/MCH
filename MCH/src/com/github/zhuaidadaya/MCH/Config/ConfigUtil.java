...
public class ConfigUtil {
    ...
    public static void uploadConfig() {
        for(String s : Arrays.asList(ConfigUtil.colorSet, ConfigUtil.languageSet, ConfigUtil.exButtonSet, ConfigUtil.fastLoadSet, ConfigUtil.onTopSet, ConfigUtil.saveCache, ConfigUtil.saveErrorLog, ConfigUtil.saveRunLog, ConfigUtil.autoPUDSet, ConfigUtil.saveHistorySet, ConfigUtil.input_command, ConfigUtil.minecraftListenFlushSpeedLevel, ConfigUtil.showInvalidCommand, ConfigUtil.showCommands, ConfigUtil.priorityDisplay, ConfigUtil.toWiki)) {
